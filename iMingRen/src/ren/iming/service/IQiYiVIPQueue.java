...
public class IQiYiVIPQueue implements VIPQueue{
	
	//这个类是多线程安全的队列
	private static ConcurrentLinkedQueue<VIP> vipList;
	private static IQiYiVIPQueue instance = new IQiYiVIPQueue();
	private IQiYiVIPQueue(){
		vipList = new ConcurrentLinkedQueue<VIP>();
	}
	public static IQiYiVIPQueue getInstance(){
		return instance;
	}
	//获取vip,返回值为VIP对象
